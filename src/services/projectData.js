export const project = [
    ...
    },
    {
      ...
      description:"Payroll System is an application of the software that automates the computation and distribution of employee paychecks. As it resolves payment and deduction concerns and digitally records them in its database, the software automatically calculates salaries, tax deductions, incentives, salaries, and bonuses."
    }
  ];
